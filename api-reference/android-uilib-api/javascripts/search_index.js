var search_data = {
    "index": {
        "searchIndex": [
             ...
             "initmapboxmap",
             "initializes the mapwidget with mapbox.  @param listener the onmapreadylistener which will invoke the onmapready method when the map has finished initializing. @param mapboxaccesstoken the api access token from mapbox.",
             "getmap",
        ...
        "info": [
            ...
            [
                   ...
                   2,
                   "/Widgets/DUXMapWidget.html",
                   "#DUXMapWidget_initMapboxMap_inline",
                   "Initializes the MapWidget with Mapbox.  @param listener The OnMapReadyListener which will invoke the onMapReady method when the map has finished initializing. @param mapboxAccessToken The API access token from Mapbox.",
            ],
            [
                   "Initializes the MapWidget with Mapbox.  @param listener The OnMapReadyListener which will invoke the onMapReady method when the map has finished initializing. @param mapboxAccessToken The API access token from Mapbox.",
