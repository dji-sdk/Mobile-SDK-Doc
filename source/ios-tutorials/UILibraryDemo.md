---
title: Creating a Simplified DJI Go app using UI Library
version: v4.0
date: 2017-04-18
...
In this tutorial, you will learn how to use DJI iOS UI Library and DJI iOS SDK to 
create a simplified DJI Go app easily, with standard DJI Go UIs and functionalities. By the end of this tutorial you will have an app that you can use to show the camera FPV view, check aircraft status, shoot photos, preview and download media files and so on.
...
### 2. Importing the VideoPreviewer and UILibrary
