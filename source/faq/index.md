...
* [Will my application work with Phantom 3 and Inspire 1 if "Supported external accessory protocols" is removed from info.plist?](#will-my-application-work-with-phantom-3-and-inspire-1-if-supported-external-accessory-protocols-is-removed-from-info-plist)
...
- For Phantom 3 Series and Inspire 1 series, you can use the [DJI PC Simulator](https://developer.dji.com/mobile-sdk/downloads/).
- For Phantom 4, M100, M600 and Mavic Pro, you can use [DJI Assistant 2](http://www.dji.com/phantom-4/info#downloads).
